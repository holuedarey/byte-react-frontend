...
function Modal(props) {
  ...
  return (
    <form className="terminal-form" onSubmit={addTerminalSubmit}>
      ...
      <div className="row mb-1 mt-1">
        <div className="col-12">
          <div className="">
            ...
            />
            {validation.terminalId != null && (
              <p className="text-danger">{validation.terminalId}</p>
            )}
        ...
        <div className="col-6">
          <div className="">
            ...
            {validation.serialNumber && (
              <p className="text-danger">{validation.serialNumber}</p>
            )}
          </div>
        </div>
        <div className="col-6">
          <div className="">
            ...
            />
            {validation.logoUrl && (
              <p className="text-danger">{validation.logoUrl}</p>
            )}
          </div>
        </div>
        <div className="col-6">
          <div className="">
            ...
            />
            {validation.physicalAddress && (
              <p className="text-danger">{validation.physicalAddress}</p>
            )}
          </div>
        </div>
        <div className="col-6">
          <div className="">
            ...
            {validation.postalAddress && (
              <p className="text-danger">{validation.postalAddress}</p>
            )}
          </div>
        </div>
        <div className="col-6">
          <div className="">
            ...
            />
            {validation.phone && (
              <p className="text-danger">{validation.phone}</p>
            )}
          </div>
        </div>
        <div className="col-6">
        ...
        <div className="col-6">
          ...
          {validation.merchantName && (
            <p className="text-danger">{validation.merchantName}</p>
          )}
        </div>
        <div className="col-6">
          <div className="form-check form-switch margin-top">
            ...
            <input
              ...
              role="switch"
              id="enabled"
              onChange={(e) => setCheckbox(!checked)}
              value={checked}
            />
          </div>
        </div>
        <div className="col-6">
          ...
          {validation.merchantId && (
            <p className="text-danger">{validation.merchantId}</p>
          )}
        </div>
        <div className="col-6">
          ...
          />
          {validation.firmwareVerion && (
            <p className="text-danger">{validation.firmwareVerion}</p>
          )}
        </div>
      </div>
      <div>
